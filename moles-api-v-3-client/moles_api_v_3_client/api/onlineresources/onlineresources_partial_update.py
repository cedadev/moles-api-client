...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/v3/onlineresources/{ob_id}/",
    }

    if isinstance(body, PatchedOnlineResourceWrite):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ob_id (int):
        body (PatchedOnlineResourceWrite): A mixin that allows specifying which fields to include
            in the serializer
