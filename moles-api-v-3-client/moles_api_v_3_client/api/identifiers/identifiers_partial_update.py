...
from ...models.patched_identifier_write import PatchedIdentifierWrite
...
def _get_kwargs(
    ...
    *,
    ...
    if isinstance(body, PatchedIdentifierWrite):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ob_id (int):
        body (PatchedIdentifierWrite): A mixin that allows specifying which fields to include in
            the serializer
