...
from ...models.patched_instrument_write_request import PatchedInstrumentWriteRequest
...
def _get_kwargs(
    ob_id: int,
    *,
    body: PatchedInstrumentWriteRequest,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ob_id (int):
        body (PatchedInstrumentWriteRequest): A mixin that allows specifying which fields to
