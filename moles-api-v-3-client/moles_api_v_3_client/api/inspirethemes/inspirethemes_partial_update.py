...
from ...models.patched_inspire_theme_write import PatchedInspireThemeWrite
...
def _get_kwargs(
    ...
    *,
    ...
    if isinstance(body, PatchedInspireThemeWrite):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ob_id (int):
        body (PatchedInspireThemeWrite): A mixin that allows specifying which fields to include in
            the serializer
