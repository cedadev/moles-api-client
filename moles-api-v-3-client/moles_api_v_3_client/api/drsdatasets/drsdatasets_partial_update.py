...
from ...models.patched_drs_dataset_write_request import PatchedDRSDatasetWriteRequest
...
def _get_kwargs(
    ob_id: int,
    *,
    body: PatchedDRSDatasetWriteRequest,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ob_id (int):
        body (PatchedDRSDatasetWriteRequest): A mixin that allows specifying which fields to
