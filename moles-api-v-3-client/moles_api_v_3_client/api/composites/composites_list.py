...
from ...models.paginated_procedure_composite_process_write_list import PaginatedProcedureCompositeProcessWriteList
...
def _get_kwargs(
    *,
    ...
    acquisition_component_ob_id: Union[Unset, int] = UNSET,
    acquisition_component_ob_id_in: Union[Unset, list[int]] = UNSET,
    acquisition_component_title: Union[Unset, str] = UNSET,
    acquisition_component_title_contains: Union[Unset, str] = UNSET,
    acquisition_component_uuid: Union[Unset, str] = UNSET,
    acquisition_component_uuid_in: Union[Unset, list[str]] = UNSET,
    computation_component_ob_id: Union[Unset, int] = UNSET,
    computation_component_ob_id_in: Union[Unset, list[int]] = UNSET,
    computation_component_title: Union[Unset, str] = UNSET,
    computation_component_title_contains: Union[Unset, str] = UNSET,
    computation_component_uuid: Union[Unset, str] = UNSET,
    computation_component_uuid_in: Union[Unset, list[str]] = UNSET,
    ...
    json_acquisition_component_ob_id_in: Union[Unset, list[int]] = UNSET
    if not isinstance(acquisition_component_ob_id_in, Unset):
        json_acquisition_component_ob_id_in = acquisition_component_ob_id_in
    ...
    json_acquisition_component_uuid_in: Union[Unset, list[str]] = UNSET
    if not isinstance(acquisition_component_uuid_in, Unset):
        json_acquisition_component_uuid_in = acquisition_component_uuid_in
    ...
    json_computation_component_ob_id_in: Union[Unset, list[int]] = UNSET
    if not isinstance(computation_component_ob_id_in, Unset):
        json_computation_component_ob_id_in = computation_component_ob_id_in
    ...
    json_computation_component_uuid_in: Union[Unset, list[str]] = UNSET
    if not isinstance(computation_component_uuid_in, Unset):
        json_computation_component_uuid_in = computation_component_uuid_in
...
) -> Optional[PaginatedProcedureCompositeProcessWriteList]:
    if response.status_code == 200:
        response_200 = PaginatedProcedureCompositeProcessWriteList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedProcedureCompositeProcessWriteList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        acquisition_component_ob_id (Union[Unset, int]):
        acquisition_component_ob_id_in (Union[Unset, list[int]]):
        acquisition_component_title (Union[Unset, str]):
        acquisition_component_title_contains (Union[Unset, str]):
        acquisition_component_uuid (Union[Unset, str]):
        acquisition_component_uuid_in (Union[Unset, list[str]]):
        computation_component_ob_id (Union[Unset, int]):
        computation_component_ob_id_in (Union[Unset, list[int]]):
        computation_component_title (Union[Unset, str]):
        computation_component_title_contains (Union[Unset, str]):
        computation_component_uuid (Union[Unset, str]):
        computation_component_uuid_in (Union[Unset, list[str]]):
