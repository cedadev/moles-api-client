...
def _get_kwargs(
    *,
    ...
    if not isinstance(acquisition_component_ob_id_in, Unset):
        json_acquisition_component_ob_id_in = ",".join(acquisition_component_ob_id_in)
    ...
    if not isinstance(acquisition_component_uuid_in, Unset):
        json_acquisition_component_uuid_in = ",".join(acquisition_component_uuid_in)
    ...
    if not isinstance(computation_component_ob_id_in, Unset):
        json_computation_component_ob_id_in = ",".join(computation_component_ob_id_in)
    ...
    if not isinstance(computation_component_uuid_in, Unset):
        json_computation_component_uuid_in = ",".join(computation_component_uuid_in)
...
) -> Optional[PaginatedProcedureCompositeProcessReadList]:
