...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/v3/composites/{ob_id}/",
    }

    if isinstance(body, PatchedProcedureCompositeProcessWrite):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ob_id (int):
        body (PatchedProcedureCompositeProcessWrite): A mixin that allows specifying which fields
