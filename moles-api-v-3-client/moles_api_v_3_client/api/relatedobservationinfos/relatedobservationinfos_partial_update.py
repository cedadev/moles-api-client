...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/v3/relatedobservationinfos/{ob_id}/",
    }

    if isinstance(body, PatchedRelatedObservationInfoWrite):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ob_id (int):
        body (PatchedRelatedObservationInfoWrite): A mixin that allows specifying which fields to
