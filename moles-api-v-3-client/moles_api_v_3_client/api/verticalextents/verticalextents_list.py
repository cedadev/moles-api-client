...
def _get_kwargs(
    *,
    ...
    if not isinstance(highest_level_bound_in, Unset):
        json_highest_level_bound_in = ",".join(highest_level_bound_in)
    ...
    if not isinstance(highest_level_bound_range, Unset):
        json_highest_level_bound_range = ",".join(highest_level_bound_range)
    ...
    if not isinstance(lowest_level_bound_in, Unset):
        json_lowest_level_bound_in = ",".join(lowest_level_bound_in)
    ...
    if not isinstance(lowest_level_bound_range, Unset):
        json_lowest_level_bound_range = ",".join(lowest_level_bound_range)
    ...
    if not isinstance(units_range, Unset):
        json_units_range = ",".join(units_range)
