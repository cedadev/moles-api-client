...
from ...models.patched_note_write_request import PatchedNoteWriteRequest
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> NoteWrite | None:
    if response.status_code == 200:
        response_200 = NoteWrite.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ob_id (int):
        body (PatchedNoteWriteRequest): A mixin that allows specifying which fields to include in
            the serializer
