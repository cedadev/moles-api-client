...
def _get_kwargs(
    *,
    ...
    if not isinstance(child_platform, Unset):
        json_child_platform = ",".join(map(str, child_platform))
    ...
    if not isinstance(child_platform_in, Unset):
        json_child_platform_in = ",".join(map(str, child_platform_in))
    ...
    if not isinstance(parent_platform, Unset):
        json_parent_platform = ",".join(map(str, parent_platform))
    ...
    if not isinstance(parent_platform_in, Unset):
        json_parent_platform_in = ",".join(map(str, parent_platform_in))
