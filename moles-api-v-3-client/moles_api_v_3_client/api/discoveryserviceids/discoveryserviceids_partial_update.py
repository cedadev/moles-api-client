...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/v3/discoveryserviceids/{ob_id}/",
    }

    if isinstance(body, PatchedDiscoveryServiceIdWrite):
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = DiscoveryServiceIdWrite.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ob_id (int):
        body (PatchedDiscoveryServiceIdWrite): A mixin that allows specifying which fields to
