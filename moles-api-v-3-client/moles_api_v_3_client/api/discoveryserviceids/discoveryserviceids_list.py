...
from ...models.paginated_discovery_service_id_write_list import PaginatedDiscoveryServiceIdWriteList
...
) -> Optional[PaginatedDiscoveryServiceIdWriteList]:
    if response.status_code == 200:
        response_200 = PaginatedDiscoveryServiceIdWriteList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedDiscoveryServiceIdWriteList]:
    return Response(
