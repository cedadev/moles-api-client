...
def _get_kwargs(
    *,
    ...
    if not isinstance(observation_collection_ob_id_in, Unset):
        json_observation_collection_ob_id_in = ",".join(observation_collection_ob_id_in)
    ...
    if not isinstance(observation_collection_uuid_in, Unset):
        json_observation_collection_uuid_in = ",".join(observation_collection_uuid_in)
    ...
    if not isinstance(parent_project_in, Unset):
        json_parent_project_in = ",".join(parent_project_in)
    ...
    if not isinstance(sub_project_ob_id_in, Unset):
        json_sub_project_ob_id_in = ",".join(sub_project_ob_id_in)
    ...
    if not isinstance(sub_project_title_in, Unset):
        json_sub_project_title_in = ",".join(sub_project_title_in)
    ...
    if not isinstance(sub_project_uuid_in, Unset):
        json_sub_project_uuid_in = ",".join(sub_project_uuid_in)
...
) -> Optional[PaginatedProjectReadList]:
