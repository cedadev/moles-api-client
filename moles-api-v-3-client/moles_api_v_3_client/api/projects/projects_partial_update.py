...
from ...models.patched_project_write_request import PatchedProjectWriteRequest
...
def _get_kwargs(
    ob_id: int,
    *,
    body: PatchedProjectWriteRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/api/v3/projects/{ob_id}/",
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ob_id (int):
        body (PatchedProjectWriteRequest): A mixin that allows specifying which fields to include
            in the serializer
