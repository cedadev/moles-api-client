...
from ...models.patched_project_write import PatchedProjectWrite
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/v3/projects/{ob_id}/",
    }

    if isinstance(body, PatchedProjectWrite):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ob_id (int):
        body (PatchedProjectWrite): A mixin that allows specifying which fields to include in the
            serializer
