...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/v3/computations/{ob_id}/",
    }

    if isinstance(body, PatchedProcedureComputationWrite):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ob_id (int):
        body (PatchedProcedureComputationWrite): A mixin that allows specifying which fields to
