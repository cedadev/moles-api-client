...
from ...models.procedure_computation_write_request import ProcedureComputationWriteRequest
...
def sync_detailed(
    *,
    ...
    Args:
        body (ProcedureComputationWriteRequest): A mixin that allows specifying which fields to
