...
T = TypeVar("T", bound="PaginatedIdentifierWriteList")


@_attrs_define
class PaginatedIdentifierWriteList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['IdentifierWrite']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = IdentifierWrite.from_dict(results_item_data)
        ...
        paginated_identifier_write_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_identifier_write_list.additional_properties = d
        return paginated_identifier_write_list
