...
if TYPE_CHECKING:
    from ..models.observation_collection_read import ObservationCollectionRead


T = TypeVar("T", bound="PaginatedObservationCollectionReadList")


@_attrs_define
class PaginatedObservationCollectionReadList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['ObservationCollectionRead']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ObservationCollectionRead.from_dict(results_item_data)
        ...
        paginated_observation_collection_read_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_observation_collection_read_list.additional_properties = d
        return paginated_observation_collection_read_list
