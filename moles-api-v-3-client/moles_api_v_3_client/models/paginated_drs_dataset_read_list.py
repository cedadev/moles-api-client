...
T = TypeVar("T", bound="PaginatedDRSDatasetReadList")


@_attrs_define
class PaginatedDRSDatasetReadList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['DRSDatasetRead']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = DRSDatasetRead.from_dict(results_item_data)
        ...
        paginated_drs_dataset_read_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_drs_dataset_read_list.additional_properties = d
        return paginated_drs_dataset_read_list
