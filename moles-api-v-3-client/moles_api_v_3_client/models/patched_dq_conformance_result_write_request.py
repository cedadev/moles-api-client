...
T = TypeVar("T", bound="PatchedDQConformanceResultWriteRequest")


@_attrs_define
class PatchedDQConformanceResultWriteRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_dq_conformance_result_write_request = cls(
        ...
        patched_dq_conformance_result_write_request.additional_properties = d
        return patched_dq_conformance_result_write_request
