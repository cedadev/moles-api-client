...
T = TypeVar("T", bound="PaginatedDiscoveryServiceIdWriteList")


@_attrs_define
class PaginatedDiscoveryServiceIdWriteList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['DiscoveryServiceIdWrite']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = DiscoveryServiceIdWrite.from_dict(results_item_data)
        ...
        paginated_discovery_service_id_write_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_discovery_service_id_write_list.additional_properties = d
        return paginated_discovery_service_id_write_list
