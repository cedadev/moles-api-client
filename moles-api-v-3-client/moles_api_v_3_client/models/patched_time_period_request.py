...
T = TypeVar("T", bound="PatchedTimePeriodRequest")


@_attrs_define
class PatchedTimePeriodRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_time_period_request = cls(
            start_time=start_time,
            end_time=end_time,
        )

        patched_time_period_request.additional_properties = d
        return patched_time_period_request
