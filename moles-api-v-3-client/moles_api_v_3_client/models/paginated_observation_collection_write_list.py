...
T = TypeVar("T", bound="PaginatedObservationCollectionWriteList")


@_attrs_define
class PaginatedObservationCollectionWriteList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['ObservationCollectionWrite']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ObservationCollectionWrite.from_dict(results_item_data)
        ...
        paginated_observation_collection_write_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_observation_collection_write_list.additional_properties = d
        return paginated_observation_collection_write_list
