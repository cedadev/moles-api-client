...
T = TypeVar("T", bound="PaginatedInstrumentPlatformPairWriteList")


@_attrs_define
class PaginatedInstrumentPlatformPairWriteList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['InstrumentPlatformPairWrite']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = InstrumentPlatformPairWrite.from_dict(results_item_data)
        ...
        paginated_instrument_platform_pair_write_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_instrument_platform_pair_write_list.additional_properties = d
        return paginated_instrument_platform_pair_write_list
