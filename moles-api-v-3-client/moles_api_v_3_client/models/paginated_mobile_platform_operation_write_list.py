...
T = TypeVar("T", bound="PaginatedMobilePlatformOperationWriteList")


@_attrs_define
class PaginatedMobilePlatformOperationWriteList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['MobilePlatformOperationWrite']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = MobilePlatformOperationWrite.from_dict(results_item_data)
        ...
        paginated_mobile_platform_operation_write_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_mobile_platform_operation_write_list.additional_properties = d
        return paginated_mobile_platform_operation_write_list
