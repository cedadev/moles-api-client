...
T = TypeVar("T", bound="PaginatedMigrationPropertyReadList")


@_attrs_define
class PaginatedMigrationPropertyReadList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[MigrationPropertyRead]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = MigrationPropertyRead.from_dict(results_item_data)
        ...
        paginated_migration_property_read_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_migration_property_read_list.additional_properties = d
        return paginated_migration_property_read_list
