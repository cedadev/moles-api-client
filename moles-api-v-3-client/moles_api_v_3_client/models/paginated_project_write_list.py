...
T = TypeVar("T", bound="PaginatedProjectWriteList")


@_attrs_define
class PaginatedProjectWriteList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['ProjectWrite']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ProjectWrite.from_dict(results_item_data)
        ...
        paginated_project_write_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_project_write_list.additional_properties = d
        return paginated_project_write_list
