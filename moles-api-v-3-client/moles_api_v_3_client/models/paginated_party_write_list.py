...
T = TypeVar("T", bound="PaginatedPartyWriteList")


@_attrs_define
class PaginatedPartyWriteList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['PartyWrite']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = PartyWrite.from_dict(results_item_data)
        ...
        paginated_party_write_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_party_write_list.additional_properties = d
        return paginated_party_write_list
