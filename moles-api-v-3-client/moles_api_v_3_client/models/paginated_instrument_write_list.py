...
T = TypeVar("T", bound="PaginatedInstrumentWriteList")


@_attrs_define
class PaginatedInstrumentWriteList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['InstrumentWrite']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = InstrumentWrite.from_dict(results_item_data)
        ...
        paginated_instrument_write_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_instrument_write_list.additional_properties = d
        return paginated_instrument_write_list
