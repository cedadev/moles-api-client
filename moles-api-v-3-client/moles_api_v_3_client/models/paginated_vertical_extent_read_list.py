...
T = TypeVar("T", bound="PaginatedVerticalExtentReadList")


@_attrs_define
class PaginatedVerticalExtentReadList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['VerticalExtentRead']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = VerticalExtentRead.from_dict(results_item_data)
        ...
        paginated_vertical_extent_read_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_vertical_extent_read_list.additional_properties = d
        return paginated_vertical_extent_read_list
