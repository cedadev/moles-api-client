...
T = TypeVar("T", bound="PaginatedInputOutputDescriptionReadList")


@_attrs_define
class PaginatedInputOutputDescriptionReadList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[InputOutputDescriptionRead]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = InputOutputDescriptionRead.from_dict(results_item_data)
        ...
        paginated_input_output_description_read_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_input_output_description_read_list.additional_properties = d
        return paginated_input_output_description_read_list
