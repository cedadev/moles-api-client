...
T = TypeVar("T", bound="PaginatedDRSDatasetWriteList")


@_attrs_define
class PaginatedDRSDatasetWriteList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['DRSDatasetWrite']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = DRSDatasetWrite.from_dict(results_item_data)
        ...
        paginated_drs_dataset_write_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_drs_dataset_write_list.additional_properties = d
        return paginated_drs_dataset_write_list
