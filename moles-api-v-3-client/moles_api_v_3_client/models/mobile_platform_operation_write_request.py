...
T = TypeVar("T", bound="MobilePlatformOperationWriteRequest")


@_attrs_define
class MobilePlatformOperationWriteRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mobile_platform_operation_write_request = cls(
            title=title,
            platform_field=platform_field,
            abstract=abstract,
            location=location,
        ...
        mobile_platform_operation_write_request.additional_properties = d
        return mobile_platform_operation_write_request
