...
T = TypeVar("T", bound="PatchedObservationWrite")


@_attrs_define
class PatchedObservationWrite:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_observation_write.additional_properties = d
        return patched_observation_write
