...
T = TypeVar("T", bound="PatchedDQConformanceResultWrite")


@_attrs_define
class PatchedDQConformanceResultWrite:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_dq_conformance_result_write = cls(
            ob_id=ob_id,
        ...
        patched_dq_conformance_result_write.additional_properties = d
        return patched_dq_conformance_result_write
