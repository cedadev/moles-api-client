...
T = TypeVar("T", bound="PaginatedPhenomenonList")


@_attrs_define
class PaginatedPhenomenonList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['Phenomenon']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Phenomenon.from_dict(results_item_data)
        ...
        paginated_phenomenon_list.additional_properties = d
        return paginated_phenomenon_list
