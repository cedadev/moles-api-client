...
T = TypeVar("T", bound="PaginatedVocabularyTermReadList")


@_attrs_define
class PaginatedVocabularyTermReadList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['VocabularyTermRead']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = VocabularyTermRead.from_dict(results_item_data)
        ...
        paginated_vocabulary_term_read_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_vocabulary_term_read_list.additional_properties = d
        return paginated_vocabulary_term_read_list
