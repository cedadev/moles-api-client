...
T = TypeVar("T", bound="PaginatedTopicCategoryReadList")


@_attrs_define
class PaginatedTopicCategoryReadList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['TopicCategoryRead']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = TopicCategoryRead.from_dict(results_item_data)
        ...
        paginated_topic_category_read_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_topic_category_read_list.additional_properties = d
        return paginated_topic_category_read_list
