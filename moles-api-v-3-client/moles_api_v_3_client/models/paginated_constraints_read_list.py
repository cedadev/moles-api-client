...
T = TypeVar("T", bound="PaginatedConstraintsReadList")


@_attrs_define
class PaginatedConstraintsReadList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['ConstraintsRead']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ConstraintsRead.from_dict(results_item_data)
        ...
        paginated_constraints_read_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_constraints_read_list.additional_properties = d
        return paginated_constraints_read_list
