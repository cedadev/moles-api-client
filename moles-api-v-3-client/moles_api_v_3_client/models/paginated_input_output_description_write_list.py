...
if TYPE_CHECKING:
    from ..models.input_output_description_write import InputOutputDescriptionWrite


T = TypeVar("T", bound="PaginatedInputOutputDescriptionWriteList")


@_attrs_define
class PaginatedInputOutputDescriptionWriteList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['InputOutputDescriptionWrite']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = InputOutputDescriptionWrite.from_dict(results_item_data)
        ...
        paginated_input_output_description_write_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_input_output_description_write_list.additional_properties = d
        return paginated_input_output_description_write_list
