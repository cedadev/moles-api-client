...
T = TypeVar("T", bound="PatchedOnlineResourceWrite")
...
class PatchedOnlineResourceWrite:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_online_resource_write = cls(
            ob_id=ob_id,
            function=function,
            linkage=linkage,
            name=name,
        ...
        patched_online_resource_write.additional_properties = d
        return patched_online_resource_write
