...
T = TypeVar("T", bound="ResponsiblePartyInfoWrite")
...
class ResponsiblePartyInfoWrite:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        responsible_party_info_write = cls(
            ob_id=ob_id,
            party=party,
            role=role,
        ...
        responsible_party_info_write.additional_properties = d
        return responsible_party_info_write
