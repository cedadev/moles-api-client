...
if TYPE_CHECKING:
    from ..models.procedure_computation_read import ProcedureComputationRead


T = TypeVar("T", bound="PaginatedProcedureComputationReadList")


@_attrs_define
class PaginatedProcedureComputationReadList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['ProcedureComputationRead']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ProcedureComputationRead.from_dict(results_item_data)
        ...
        paginated_procedure_computation_read_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_procedure_computation_read_list.additional_properties = d
        return paginated_procedure_computation_read_list
