...
T = TypeVar("T", bound="VerticalExtentWriteRequest")


@_attrs_define
class VerticalExtentWriteRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        vertical_extent_write_request = cls(
            highest_level_bound=highest_level_bound,
            lowest_level_bound=lowest_level_bound,
            units=units,
        )

        vertical_extent_write_request.additional_properties = d
        return vertical_extent_write_request
