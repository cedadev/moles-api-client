...
T = TypeVar("T", bound="PatchedObservationCollectionWrite")
...
class PatchedObservationCollectionWrite:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_observation_collection_write = cls(
            ob_id=ob_id,
            uuid=uuid,
        ...
        patched_observation_collection_write.additional_properties = d
        return patched_observation_collection_write
