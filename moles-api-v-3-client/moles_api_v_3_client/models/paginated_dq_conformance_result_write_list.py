...
T = TypeVar("T", bound="PaginatedDQConformanceResultWriteList")


@_attrs_define
class PaginatedDQConformanceResultWriteList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['DQConformanceResultWrite']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = DQConformanceResultWrite.from_dict(results_item_data)
        ...
        paginated_dq_conformance_result_write_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_dq_conformance_result_write_list.additional_properties = d
        return paginated_dq_conformance_result_write_list
