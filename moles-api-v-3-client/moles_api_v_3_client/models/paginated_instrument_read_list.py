...
if TYPE_CHECKING:
    from ..models.instrument_read import InstrumentRead


T = TypeVar("T", bound="PaginatedInstrumentReadList")


@_attrs_define
class PaginatedInstrumentReadList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['InstrumentRead']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = InstrumentRead.from_dict(results_item_data)
        ...
        paginated_instrument_read_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_instrument_read_list.additional_properties = d
        return paginated_instrument_read_list
