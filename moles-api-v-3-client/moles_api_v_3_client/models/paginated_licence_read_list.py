...
T = TypeVar("T", bound="PaginatedLicenceReadList")


@_attrs_define
class PaginatedLicenceReadList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['LicenceRead']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = LicenceRead.from_dict(results_item_data)
        ...
        paginated_licence_read_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_licence_read_list.additional_properties = d
        return paginated_licence_read_list
