...
T = TypeVar("T", bound="PatchedTimePeriod")


@_attrs_define
class PatchedTimePeriod:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_time_period = cls(
            ob_id=ob_id,
            start_time=start_time,
            end_time=end_time,
        )

        patched_time_period.additional_properties = d
        return patched_time_period
