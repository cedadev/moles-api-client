...
T = TypeVar("T", bound="TimePeriodRequest")


@_attrs_define
class TimePeriodRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        time_period_request = cls(
            start_time=start_time,
            end_time=end_time,
        )

        time_period_request.additional_properties = d
        return time_period_request
