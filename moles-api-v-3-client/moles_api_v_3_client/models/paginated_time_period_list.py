...
T = TypeVar("T", bound="PaginatedTimePeriodList")


@_attrs_define
class PaginatedTimePeriodList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = TimePeriod.from_dict(results_item_data)
        ...
        paginated_time_period_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_time_period_list.additional_properties = d
        return paginated_time_period_list
