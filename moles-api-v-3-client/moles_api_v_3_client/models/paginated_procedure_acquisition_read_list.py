...
T = TypeVar("T", bound="PaginatedProcedureAcquisitionReadList")


@_attrs_define
class PaginatedProcedureAcquisitionReadList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[ProcedureAcquisitionRead]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ProcedureAcquisitionRead.from_dict(results_item_data)
        ...
        paginated_procedure_acquisition_read_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_procedure_acquisition_read_list.additional_properties = d
        return paginated_procedure_acquisition_read_list
