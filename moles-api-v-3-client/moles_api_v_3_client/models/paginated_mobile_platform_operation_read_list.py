...
T = TypeVar("T", bound="PaginatedMobilePlatformOperationReadList")


@_attrs_define
class PaginatedMobilePlatformOperationReadList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[MobilePlatformOperationRead]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = MobilePlatformOperationRead.from_dict(results_item_data)
        ...
        paginated_mobile_platform_operation_read_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_mobile_platform_operation_read_list.additional_properties = d
        return paginated_mobile_platform_operation_read_list
