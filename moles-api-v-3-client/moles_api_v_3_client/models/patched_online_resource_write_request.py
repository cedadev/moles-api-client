...
T = TypeVar("T", bound="PatchedOnlineResourceWriteRequest")


@_attrs_define
class PatchedOnlineResourceWriteRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_online_resource_write_request = cls(
            function=function,
            linkage=linkage,
            name=name,
        ...
        patched_online_resource_write_request.additional_properties = d
        return patched_online_resource_write_request
