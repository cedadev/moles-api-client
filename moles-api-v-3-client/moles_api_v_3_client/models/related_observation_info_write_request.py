...
T = TypeVar("T", bound="RelatedObservationInfoWriteRequest")


@_attrs_define
class RelatedObservationInfoWriteRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        related_observation_info_write_request = cls(
            subject_observation=subject_observation,
            relation_type=relation_type,
            object_observation=object_observation,
        )

        related_observation_info_write_request.additional_properties = d
        return related_observation_info_write_request
