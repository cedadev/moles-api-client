...
T = TypeVar("T", bound="PaginatedProjectReadList")


@_attrs_define
class PaginatedProjectReadList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ProjectRead.from_dict(results_item_data)
        ...
        paginated_project_read_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_project_read_list.additional_properties = d
        return paginated_project_read_list
