...
T = TypeVar("T", bound="PaginatedResultWriteList")


@_attrs_define
class PaginatedResultWriteList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['ResultWrite']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ResultWrite.from_dict(results_item_data)
        ...
        paginated_result_write_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_result_write_list.additional_properties = d
        return paginated_result_write_list
