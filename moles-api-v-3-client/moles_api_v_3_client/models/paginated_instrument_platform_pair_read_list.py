...
T = TypeVar("T", bound="PaginatedInstrumentPlatformPairReadList")


@_attrs_define
class PaginatedInstrumentPlatformPairReadList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['InstrumentPlatformPairRead']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = InstrumentPlatformPairRead.from_dict(results_item_data)
        ...
        paginated_instrument_platform_pair_read_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_instrument_platform_pair_read_list.additional_properties = d
        return paginated_instrument_platform_pair_read_list
