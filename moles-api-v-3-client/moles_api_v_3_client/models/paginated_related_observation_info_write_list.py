...
T = TypeVar("T", bound="PaginatedRelatedObservationInfoWriteList")


@_attrs_define
class PaginatedRelatedObservationInfoWriteList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['RelatedObservationInfoWrite']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RelatedObservationInfoWrite.from_dict(results_item_data)
        ...
        paginated_related_observation_info_write_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_related_observation_info_write_list.additional_properties = d
        return paginated_related_observation_info_write_list
