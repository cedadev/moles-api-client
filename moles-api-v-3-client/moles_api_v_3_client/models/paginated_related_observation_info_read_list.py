...
if TYPE_CHECKING:
    from ..models.related_observation_info_read import RelatedObservationInfoRead


T = TypeVar("T", bound="PaginatedRelatedObservationInfoReadList")


@_attrs_define
class PaginatedRelatedObservationInfoReadList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['RelatedObservationInfoRead']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RelatedObservationInfoRead.from_dict(results_item_data)
        ...
        paginated_related_observation_info_read_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_related_observation_info_read_list.additional_properties = d
        return paginated_related_observation_info_read_list
