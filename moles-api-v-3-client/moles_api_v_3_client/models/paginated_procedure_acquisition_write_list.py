...
T = TypeVar("T", bound="PaginatedProcedureAcquisitionWriteList")


@_attrs_define
class PaginatedProcedureAcquisitionWriteList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['ProcedureAcquisitionWrite']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ProcedureAcquisitionWrite.from_dict(results_item_data)
        ...
        paginated_procedure_acquisition_write_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_procedure_acquisition_write_list.additional_properties = d
        return paginated_procedure_acquisition_write_list
