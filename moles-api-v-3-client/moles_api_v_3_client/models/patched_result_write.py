...
T = TypeVar("T", bound="PatchedResultWrite")


@_attrs_define
class PatchedResultWrite:
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.data_path, Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_result_write.additional_properties = d
        return patched_result_write
