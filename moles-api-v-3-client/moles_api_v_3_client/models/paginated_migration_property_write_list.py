...
T = TypeVar("T", bound="PaginatedMigrationPropertyWriteList")


@_attrs_define
class PaginatedMigrationPropertyWriteList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['MigrationPropertyWrite']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = MigrationPropertyWrite.from_dict(results_item_data)
        ...
        paginated_migration_property_write_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_migration_property_write_list.additional_properties = d
        return paginated_migration_property_write_list
