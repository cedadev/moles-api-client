...
T = TypeVar("T", bound="PaginatedProcedureCompositeProcessWriteList")


@_attrs_define
class PaginatedProcedureCompositeProcessWriteList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['ProcedureCompositeProcessWrite']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ProcedureCompositeProcessWrite.from_dict(results_item_data)
        ...
        paginated_procedure_composite_process_write_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_procedure_composite_process_write_list.additional_properties = d
        return paginated_procedure_composite_process_write_list
