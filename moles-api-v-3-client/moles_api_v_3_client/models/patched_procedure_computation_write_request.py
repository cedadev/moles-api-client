...
T = TypeVar("T", bound="PatchedProcedureComputationWriteRequest")


@_attrs_define
class PatchedProcedureComputationWriteRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_procedure_computation_write_request = cls(
            title=title,
            abstract=abstract,
            keywords=keywords,
        ...
        patched_procedure_computation_write_request.additional_properties = d
        return patched_procedure_computation_write_request
