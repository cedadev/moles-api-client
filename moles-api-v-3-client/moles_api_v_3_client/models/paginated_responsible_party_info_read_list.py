...
if TYPE_CHECKING:
    from ..models.responsible_party_info_read import ResponsiblePartyInfoRead


T = TypeVar("T", bound="PaginatedResponsiblePartyInfoReadList")


@_attrs_define
class PaginatedResponsiblePartyInfoReadList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['ResponsiblePartyInfoRead']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ResponsiblePartyInfoRead.from_dict(results_item_data)
        ...
        paginated_responsible_party_info_read_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_responsible_party_info_read_list.additional_properties = d
        return paginated_responsible_party_info_read_list
