...
T = TypeVar("T", bound="ObservationCollectionWriteRequest")


@_attrs_define
class ObservationCollectionWriteRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        observation_collection_write_request = cls(
            member=member,
            title=title,
            abstract=abstract,
            keywords=keywords,
        ...
        observation_collection_write_request.additional_properties = d
        return observation_collection_write_request
