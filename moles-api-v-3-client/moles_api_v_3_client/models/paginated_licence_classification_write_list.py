...
T = TypeVar("T", bound="PaginatedLicenceClassificationWriteList")


@_attrs_define
class PaginatedLicenceClassificationWriteList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['LicenceClassificationWrite']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = LicenceClassificationWrite.from_dict(results_item_data)
        ...
        paginated_licence_classification_write_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_licence_classification_write_list.additional_properties = d
        return paginated_licence_classification_write_list
