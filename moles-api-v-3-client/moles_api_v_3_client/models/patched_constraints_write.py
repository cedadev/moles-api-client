...
T = TypeVar("T", bound="PatchedConstraintsWrite")
...
class PatchedConstraintsWrite:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_constraints_write.additional_properties = d
        return patched_constraints_write
