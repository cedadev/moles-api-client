...
T = TypeVar("T", bound="PaginatedPlatformWriteList")


@_attrs_define
class PaginatedPlatformWriteList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['PlatformWrite']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = PlatformWrite.from_dict(results_item_data)
        ...
        paginated_platform_write_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_platform_write_list.additional_properties = d
        return paginated_platform_write_list
