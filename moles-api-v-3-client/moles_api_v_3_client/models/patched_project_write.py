...
T = TypeVar("T", bound="PatchedProjectWrite")


@_attrs_define
class PatchedProjectWrite:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_project_write.additional_properties = d
        return patched_project_write
