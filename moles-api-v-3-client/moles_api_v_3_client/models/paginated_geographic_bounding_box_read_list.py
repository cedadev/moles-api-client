...
T = TypeVar("T", bound="PaginatedGeographicBoundingBoxReadList")


@_attrs_define
class PaginatedGeographicBoundingBoxReadList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['GeographicBoundingBoxRead']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = GeographicBoundingBoxRead.from_dict(results_item_data)
        ...
        paginated_geographic_bounding_box_read_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_geographic_bounding_box_read_list.additional_properties = d
        return paginated_geographic_bounding_box_read_list
