...
T = TypeVar("T", bound="PaginatedInspireThemeWriteList")


@_attrs_define
class PaginatedInspireThemeWriteList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['InspireThemeWrite']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = InspireThemeWrite.from_dict(results_item_data)
        ...
        paginated_inspire_theme_write_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_inspire_theme_write_list.additional_properties = d
        return paginated_inspire_theme_write_list
