...
T = TypeVar("T", bound="VocabularyTermWriteRequest")


@_attrs_define
class VocabularyTermWriteRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        vocabulary_term_write_request = cls(
            vocab_service=vocab_service,
            uri=uri,
            resolved_term=resolved_term,
        )

        vocabulary_term_write_request.additional_properties = d
        return vocabulary_term_write_request
