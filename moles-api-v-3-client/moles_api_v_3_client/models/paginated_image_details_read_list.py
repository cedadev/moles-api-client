...
T = TypeVar("T", bound="PaginatedImageDetailsReadList")


@_attrs_define
class PaginatedImageDetailsReadList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[ImageDetailsRead]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ImageDetailsRead.from_dict(results_item_data)
        ...
        paginated_image_details_read_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_image_details_read_list.additional_properties = d
        return paginated_image_details_read_list
