...
T = TypeVar("T", bound="PaginatedDQConformanceResultReadList")


@_attrs_define
class PaginatedDQConformanceResultReadList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[DQConformanceResultRead]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = DQConformanceResultRead.from_dict(results_item_data)
        ...
        paginated_dq_conformance_result_read_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_dq_conformance_result_read_list.additional_properties = d
        return paginated_dq_conformance_result_read_list
