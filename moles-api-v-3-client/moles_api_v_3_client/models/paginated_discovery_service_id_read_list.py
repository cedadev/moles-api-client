...
T = TypeVar("T", bound="PaginatedDiscoveryServiceIdReadList")


@_attrs_define
class PaginatedDiscoveryServiceIdReadList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['DiscoveryServiceIdRead']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = DiscoveryServiceIdRead.from_dict(results_item_data)
        ...
        paginated_discovery_service_id_read_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_discovery_service_id_read_list.additional_properties = d
        return paginated_discovery_service_id_read_list
