...
T = TypeVar("T", bound="PaginatedReferenceableList")


@_attrs_define
class PaginatedReferenceableList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['Referenceable']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Referenceable.from_dict(results_item_data)
        ...
        paginated_referenceable_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_referenceable_list.additional_properties = d
        return paginated_referenceable_list
