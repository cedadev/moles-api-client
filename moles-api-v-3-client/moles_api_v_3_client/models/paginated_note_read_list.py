...
T = TypeVar("T", bound="PaginatedNoteReadList")


@_attrs_define
class PaginatedNoteReadList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = NoteRead.from_dict(results_item_data)
        ...
        paginated_note_read_list.additional_properties = d
        return paginated_note_read_list
