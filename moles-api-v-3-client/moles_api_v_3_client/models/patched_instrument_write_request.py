...
T = TypeVar("T", bound="PatchedInstrumentWriteRequest")


@_attrs_define
class PatchedInstrumentWriteRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_instrument_write_request = cls(
            title=title,
            abstract=abstract,
            keywords=keywords,
        ...
        patched_instrument_write_request.additional_properties = d
        return patched_instrument_write_request
