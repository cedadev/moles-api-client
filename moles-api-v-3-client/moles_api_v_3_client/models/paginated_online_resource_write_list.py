...
T = TypeVar("T", bound="PaginatedOnlineResourceWriteList")


@_attrs_define
class PaginatedOnlineResourceWriteList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['OnlineResourceWrite']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = OnlineResourceWrite.from_dict(results_item_data)
        ...
        paginated_online_resource_write_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_online_resource_write_list.additional_properties = d
        return paginated_online_resource_write_list
