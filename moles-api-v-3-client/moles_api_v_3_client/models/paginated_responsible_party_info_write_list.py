...
T = TypeVar("T", bound="PaginatedResponsiblePartyInfoWriteList")


@_attrs_define
class PaginatedResponsiblePartyInfoWriteList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['ResponsiblePartyInfoWrite']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ResponsiblePartyInfoWrite.from_dict(results_item_data)
        ...
        paginated_responsible_party_info_write_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_responsible_party_info_write_list.additional_properties = d
        return paginated_responsible_party_info_write_list
