...
T = TypeVar("T", bound="PaginatedOnlineResourceReadList")


@_attrs_define
class PaginatedOnlineResourceReadList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['OnlineResourceRead']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = OnlineResourceRead.from_dict(results_item_data)
        ...
        paginated_online_resource_read_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_online_resource_read_list.additional_properties = d
        return paginated_online_resource_read_list
