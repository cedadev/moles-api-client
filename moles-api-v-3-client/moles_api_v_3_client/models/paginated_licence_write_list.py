...
T = TypeVar("T", bound="PaginatedLicenceWriteList")


@_attrs_define
class PaginatedLicenceWriteList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['LicenceWrite']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = LicenceWrite.from_dict(results_item_data)
        ...
        paginated_licence_write_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_licence_write_list.additional_properties = d
        return paginated_licence_write_list
