...
T = TypeVar("T", bound="PaginatedTopicCategoryWriteList")


@_attrs_define
class PaginatedTopicCategoryWriteList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['TopicCategoryWrite']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = TopicCategoryWrite.from_dict(results_item_data)
        ...
        paginated_topic_category_write_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_topic_category_write_list.additional_properties = d
        return paginated_topic_category_write_list
