...
T = TypeVar("T", bound="ProcedureComputationWriteRequest")


@_attrs_define
class ProcedureComputationWriteRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        procedure_computation_write_request = cls(
            title=title,
            abstract=abstract,
            keywords=keywords,
        ...
        procedure_computation_write_request.additional_properties = d
        return procedure_computation_write_request
