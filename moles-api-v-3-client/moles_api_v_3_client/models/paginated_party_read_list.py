...
T = TypeVar("T", bound="PaginatedPartyReadList")


@_attrs_define
class PaginatedPartyReadList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['PartyRead']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = PartyRead.from_dict(results_item_data)
        ...
        paginated_party_read_list.additional_properties = d
        return paginated_party_read_list
