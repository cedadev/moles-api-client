...
T = TypeVar("T", bound="PatchedGeographicBoundingBoxWrite")


@_attrs_define
class PatchedGeographicBoundingBoxWrite:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_geographic_bounding_box_write = cls(
            ob_id=ob_id,
            bbox_name=bbox_name,
        ...
        patched_geographic_bounding_box_write.additional_properties = d
        return patched_geographic_bounding_box_write
