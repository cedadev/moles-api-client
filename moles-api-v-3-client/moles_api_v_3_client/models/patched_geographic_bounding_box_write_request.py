...
T = TypeVar("T", bound="PatchedGeographicBoundingBoxWriteRequest")


@_attrs_define
class PatchedGeographicBoundingBoxWriteRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_geographic_bounding_box_write_request = cls(
            bbox_name=bbox_name,
        ...
        patched_geographic_bounding_box_write_request.additional_properties = d
        return patched_geographic_bounding_box_write_request
