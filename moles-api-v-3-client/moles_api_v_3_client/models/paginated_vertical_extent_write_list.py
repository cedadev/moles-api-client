...
T = TypeVar("T", bound="PaginatedVerticalExtentWriteList")


@_attrs_define
class PaginatedVerticalExtentWriteList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['VerticalExtentWrite']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = VerticalExtentWrite.from_dict(results_item_data)
        ...
        paginated_vertical_extent_write_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_vertical_extent_write_list.additional_properties = d
        return paginated_vertical_extent_write_list
