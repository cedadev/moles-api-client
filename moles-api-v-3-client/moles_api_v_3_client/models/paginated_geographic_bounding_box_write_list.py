...
T = TypeVar("T", bound="PaginatedGeographicBoundingBoxWriteList")


@_attrs_define
class PaginatedGeographicBoundingBoxWriteList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['GeographicBoundingBoxWrite']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = GeographicBoundingBoxWrite.from_dict(results_item_data)
        ...
        paginated_geographic_bounding_box_write_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_geographic_bounding_box_write_list.additional_properties = d
        return paginated_geographic_bounding_box_write_list
