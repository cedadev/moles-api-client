...
if TYPE_CHECKING:
    from ..models.identifier_read import IdentifierRead


T = TypeVar("T", bound="PaginatedIdentifierReadList")


@_attrs_define
class PaginatedIdentifierReadList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[IdentifierRead]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = IdentifierRead.from_dict(results_item_data)
        ...
        paginated_identifier_read_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_identifier_read_list.additional_properties = d
        return paginated_identifier_read_list
